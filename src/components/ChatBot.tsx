...
const ChatBot: React.FC = () => {
  ...
  useEffect(() => {
    if (isOpen && messages.length === 0) {
      const welcomeMessage: Message = {
        id: 'welcome',
        text: "Hello! I'm sam, Samuel's AI assistant. I can help you learn about his skills, projects, and experience. What would you like to know?",
        isBot: true,
        timestamp: new Date(),
        isTyping: true
      };
  ...
  const getResponse = (input: string): string => {
    ...
    if (lowerInput.includes('skill') || lowerInput.includes('technology') || lowerInput.includes('tech') || lowerInput.includes('programming')) {
      ...
      return "Hello! Great to meet you! I'm sam, Samuel's AI assistant, here to help you learn more about his professional journey. What specific area interests you most - his skills, projects, or experience?";
          ...
          >
            ...
            <div className="flex items-center justify-between p-4 border-b border-white/10 bg-white/5">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-white font-bold text-sm">sam</h3>
